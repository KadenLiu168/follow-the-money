...
bundle 通过完整校验后，才允许 carry-forward unchanged slice；blocked 或 failed
Provider acquisition 不会 carry-forward prior evidence。仓库中不存在任何凭据、模型或 LLM runtime。独立的 private
