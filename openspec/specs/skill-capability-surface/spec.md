...
- **THEN** only the semantic capability surface has been added and no concrete Agent object, schema, facade, adapter, protocol, orchestration, or production wiring has been introduced
...
- **THEN** responsibility, mutation, and trust remain deferred to ECO-34; grounding, validation ownership, unsupported-claim, retry, and rewrite decisions remain deferred to ECO-35; and runtime implementation remains deferred beyond ECO-33
